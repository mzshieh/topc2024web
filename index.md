...
We regret to announce that codes submitted from some teams were found to be either copied from each other or similar to code generated by generative AI. Investigations and confirmations will take some time, and the final results of the contest are expected to be announced by September 14, 2024.
